...
- (void)fbDialogLogin:(NSString *)token expirationDate:(NSDate *)expirationDate {
  ...
  if ([self.sessionDelegate respondsToSelector:@selector(fbDidLogin)]) {
    ...
    if ([self.sessionDelegate respondsToSelector:@selector(fbDidLoginWithAccessToken:expirationDate:)]) {
        [_sessionDelegate fbDidLoginWithAccessToken:self.accessToken expirationDate:self.expirationDate];
    }    
}
